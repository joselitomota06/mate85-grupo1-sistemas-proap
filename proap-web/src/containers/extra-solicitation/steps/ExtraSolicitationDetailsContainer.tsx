...
import { Box, Checkbox, FormControl, FormControlLabel, FormHelperText, Grid, Typography } from "@mui/material";
...
export default function ExtraSolicitationDetailsFormContainer() {
  const { values, touched, errors } = useFormikContext<ExtraSolicitationFormValues>();
  console.log(values);
    ...
    <Grid container>
      ...
      <Grid item md={12} xs={12}>
        <Typography variant="subtitle1" style={{ color: "gray" }}>
          Confirmo envio do formulário e que as informações enviadas serão analisadas
