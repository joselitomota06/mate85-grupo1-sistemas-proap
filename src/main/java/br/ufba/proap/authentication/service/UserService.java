...
public class UserService implements UserDetailsService {
	...
	public User updateCustomerContacts(User user) {
	    User myCustomer = userRepository.findByUser(user.getEmail(), user.getCpf());
	    myCustomer.password = passwordEncoder.encode(user.getPassword());
